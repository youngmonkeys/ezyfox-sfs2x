 ...
 *
 */
public class ParamTransformerTest3 extends BaseCommandTest {
    
    public ParamTransformerTest3() {
        super();
        init();
    }
        ...
        long time = Performance.create()
            ...
            .test(new Script() {
                ...
                public void execute() {
                    ...
                    transformer.transform(new ResponseData());
                }
            }).getTime();
        System.out.println("time to test = " + time);
    }
    ...
    public void doTest() {
        ...
        assertEquals(object.getUtfString("1"), "value");
        
        ISFSArray array = value.getSFSArray("array");
        assertEquals(array.size(), 2);
        assertEquals(array.getSFSObject(0).getUtfString("1"), "value");
        assertEquals(array.getSFSObject(1).getUtfString("1"), "value");
    }
    ...
    public static class ResponseDataSerializer implements ObjectSerializer<ResponseData> {
        ...
        public Parameters serialize(ResponseData data) {
            ...
            answer.set("object", data.getObject());
            answer.set("array", data.getArray());
